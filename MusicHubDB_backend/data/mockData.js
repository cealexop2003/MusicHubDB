...
const users = [
  { user_id: 1, concert_id: 6, name: 'Julian Casablancas', age: 45, address: 'Tsimiski 100, Thessaloniki', range: 'A2-E5' },
  { user_id: 7891, concert_id: null, name: 'Nick Valensi', age: 42, address: 'Mitropoleos 50, Thessaloniki', range: 'G2-C5' },
  { user_id: 9431, concert_id: null, name: 'Fabrizio Moretti', age: 43, address: 'Egnatia 75, Thessaloniki', range: null },
  { user_id: 15627, concert_id: 579, name: 'Albert Hammond Jr.', age: 43, address: 'Aristotelous 25, Thessaloniki', range: 'A2-D5' },
  { user_id: 9888, concert_id: null, name: 'Nikolai Fraiture', age: 44, address: 'Proxenou Koromila 15, Thessaloniki', range: 'E1-A3' },
  { user_id: 12345, concert_id: null, name: 'Maria Papadopoulou', age: 28, address: 'Komninon 8, Thessaloniki', range: 'C3-A5' },
  { user_id: 27111, concert_id: null, name: 'Dimitris Nikolaidis', age: 35, address: 'Vasilissis Olgas 45, Thessaloniki', range: 'F2-C5' },
  { user_id: 32673, concert_id: 999, name: 'Sofia Georgiou', age: 26, address: 'Karaoli kai Dimitriou 30, Thessaloniki', range: 'D3-B5' },
  { user_id: 39037, concert_id: 888, name: 'Alexandros Petrou', age: 31, address: 'Leontos Sofou 12, Thessaloniki', range: 'B2-F4' },
  { user_id: 58958, concert_id: null, name: 'Elena Katsarou', age: 22, address: 'Agias Sofias 60, Thessaloniki', range: 'E3-C6' },
  { user_id: 49834, concert_id: null, name: 'Giorgos Ioannou', age: 19, address: 'Ethnikis Aminis 20, Thessaloniki', range: 'G2-E5' }
];
